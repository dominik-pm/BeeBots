...
export class PhemexClient {
    ...
    public static async AmendOrderByOrderID(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async CancelSingleOrder(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
        assert(params.orderID, "Parameter orderID is required");
    ...
    public static async BulkCancelOrders(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async CancelAllOrders(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async QueryTradingAccountAndPositions(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
    ...
    public static async ChangeLeverage(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
        assert(params.leverage != undefined, "Parameter leverage is required");
        return await putRequest("/accounts/accountPositions", params, options);
    }

    // Change position risklimit `PUT /positions/leverage`
    public static async ChangeRiskLimit(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async AssignPositionBalance(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
    ...
    public static async QueryOpenOrdersBySymbol(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async QueryClosedOrdersBySymbol(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async QueryOrder(params: Parameters, options: PhemexRequestOptions = opt) {
        return await getRequest("/exchange/order", params, options);
    }

    // Query user trade `GET /exchange/order/trade`
    public static async QueryUserTrades(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async QueryOrderBook(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async QueryRecentTrades(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    public static async Query24HourTicker(params: Parameters, options: PhemexRequestOptions = opt) {
        assert(params, "No params were passed");
        assert(params.symbol, "Parameter symbol is required");
    ...
    // public static async QueryClientsAndWallets(params: Parameters, options: PhemexRequestOptions = opt) {
    //     return await getRequest("/phemex-user/users/children", params, options);
    // }

    // // Wallet transfer Out `POST /exchange/wallets/transferOut`
    // public static async WalletTransferOut(params: Parameters, options: PhemexRequestOptions = opt) {
    //     assert(params, "No params were passed");
    ...
    // public static async WalletTransferIn(params: Parameters, options: PhemexRequestOptions = opt) {
    //     assert(params, "No params were passed");
    ...
    // public static async TransferWalletAndTradingAccount(params: Parameters, options: PhemexRequestOptions = opt) {
    //     assert(params, "No params were passed");
    ...
    // public static async QueryWalletOrTradingAccountHistory(params: Parameters, options: PhemexRequestOptions = opt) {
    //     return await getRequest("/exchange/margins/transfer", params, options);
    // }

    // // Withdraw `POST /exchange/wallets/createWithdraw`
    // public static async RequestWithdraw(params: Parameters, options: PhemexRequestOptions = opt) {
    //     assert(params, "No params were passed");
    ...
    // public static async ConfirmWithdraw(params: Parameters, options: PhemexRequestOptions = opt) {
    //     assert(params, "No params were passed");
    ...
    // public static async CancelWithdraw(params: Parameters, options: PhemexRequestOptions = opt) {
    //     assert(params, "No params were passed");
    ...
    // public static async ListWithdraws(params: Parameters, options: PhemexRequestOptions = opt) {
    //     assert(params.currency, "Parameter currency is required");
    ...
    // public static async WithdrawAddressManagement(params: Parameters, options: PhemexRequestOptions = opt) {
    //     assert(params, "No params were passed");
    //     assert(params.address, "Parameter address is required");
    //     assert(params.currency, "Parameter currency is required");
